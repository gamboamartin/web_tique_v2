...
// (esta información se obtiene del método post del formulario _texto_informacion_hogar.php)
    ...
    $contenido->subject = 'Requiero informacion acerca de'. $_POST['hogar']; //asunto de la notificación
    ...
    //si se envía exitosamente la notificación nos redirigiremos a la url_redireccion la cual también la obtendremos del formulario _texto_informacion_hogar.php
}