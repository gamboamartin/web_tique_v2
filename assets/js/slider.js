...
$(document).on('ready', function () {
    /* init */
    var _headerSlider= $("#deslizador_slider");
    ...
    if ($('.slider-full-height').length) {
        ...
        var _a = $('.deslizador_slider .carousel.slider-tall .carousel-inner .item');
        if (height)
            _a.height(height);
    ...
    if (!Modernizr.prefixed('objectFit')) {
        $('.object-fit-container, .image-box, .img-circle-cover, .deslizador_slider .item, #property-slider .item').each(function () {
            var $container = $(this);
