...
<div class="widget-body">
	...
	<style type="text/css">
        ...
        <p align="justify" style="text-indent: 1.27cm; margin-bottom: 0cm"><font size="2" style="font-family: Montserrat-Light; font-size: 13px">Llegar es fácil, Tomando como punto de partida el cruce de Av. Vallarta y Periférico hay que circular por la carretera Guadalajara-Tepic. aproximadamente a 10 Km.
