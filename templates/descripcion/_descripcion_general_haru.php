...
<font size="2" style="font-size: 13px; font-family: Montserrat-Light;">Hogar Haru bonito Departamento que se encuentra en una zona ideal para vivir
    por su excelente ubicación dentro del Municipio de Guadalajara, Jalisco, este Departamento se
    caracteriza por su confort y su amplia distribución y construcción, Hogar Haru es ideal para la
...
<p align="justify" style="text-indent: 1.27cm; margin-bottom: 0cm"><font size="2" style="font-family: Montserrat-Light; font-size: 13px">Hogar Haru es un Departamento en Planta baja distribuido de la siguiente manera 2
        recamaras, 1 baño completo, cocina, comedor, sala, patio trasero de servicio y cochera
       </font></p>
<p align="justify" style="margin-bottom: 0.5cm">

<p align="justify" style="text-indent: 1.27cm; margin-bottom: 0cm"><font size="2" style="font-family: Montserrat-Light; font-size: 13px"> Para acceder a Hogar Haru se puede hacer
        mediante Av. Artesanos, Av. Jose María Iglesias importantes vialidades de la Ciudad, así
        mismo se encuentra muy cerca de Gran Terraza Oblatos, y Plaza Punto Oriente
    </font>
</p>
