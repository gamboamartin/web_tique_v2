...
<div class="col-md-4 col-sm-6" >
    ...
    <div class="property-card card color_cart_casa" >
        ...
        <br><br>
        <a type="button" href="<?php echo $generales->url_base; ?>hogares/hogar-beatriz.php" class="btn_info_cart_casa" >  Detalles  </a>
        ...
        <?php //include $generales->path_base.'templates/lista_casas/links/_marca_venta.php' ?>
        <?php include $generales->path_base.'templates/lista_casas_slider/hogar-beatriz/_carta_casa_detalles.php' ?>
    </div>
</div>
<script>//<![CDATA[
