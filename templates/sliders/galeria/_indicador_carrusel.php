...
<ol class="carousel-indicators" >
    <li id="viñeta_slider" data-target="#deslizador_slider" data-slide-to="0" class="active "></li>
    <li id="viñeta_slider" data-target="#deslizador_slider" data-slide-to="1"></li>
    ...
    <li id="viñeta_slider" data-target="#deslizador_slider" data-slide-to="6"></li>
