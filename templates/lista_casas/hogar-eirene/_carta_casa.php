...
<div class="col-md-4 col-sm-6">
    <div class="property-card card">
        <div class="property-card-header image-box" style="border-radius:20px 20px 20px 20px !important; height: 300px !important;">
            <img style="border-radius:20px 20px 20px 20px !important; height: 300px !important;" src="<?php echo $generales->url_base;?>assets/img/venta_casas/hogar_eirene/2Sala/20220810_170200.jpg" alt="" class="" />
